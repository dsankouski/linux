...
#define CHG_CNFG_00_MODE_MASK		        GENMASK(3, 0)
...
#define CHG_CNFG_02_OTG_ILIM_MASK		GENMASK(7, 6)
...
#define CHG_CNFG_04_CHG_CV_PRM_MASK             GENMASK(5, 0)

/* MAX77705_CHG_REG_CHG_CNFG_05 */
#define CHG_CNFG_05_REG_B2SOVRC_SHIFT		0
#define CHG_CNFG_05_REG_B2SOVRC_MASK		GENMASK(3, 0)
...
#define CHG_CNFG_01_WDTCLR_MASK			GENMASK(1, 0)
...
#define CHG_CNFG_07_REG_FMBST_MASK		BIT(CHG_CNFG_07_REG_FMBST_SHIFT)
#define CHG_CNFG_07_REG_FGSRC_SHIFT		1
#define CHG_CNFG_07_REG_FGSRC_MASK		BIT(CHG_CNFG_07_REG_FGSRC_SHIFT)

/* MAX77705_CHG_REG_CHG_CNFG_08 */
#define CHG_CNFG_08_REG_FSW_SHIFT		0
#define CHG_CNFG_08_REG_FSW_MASK		GENMASK(1, 0)
...
#define CHG_CNFG_11_VBYPSET_MASK		GENMASK(6, 0)
...
#define CHG_CNFG_12_VCHGIN_REG_MASK		GENMASK(4, 3)
#define CHG_CNFG_12_WCIN_REG_MASK		GENMASK(2, 1)
#define CHG_CNFG_12_REG_DISKIP_SHIFT		0
#define CHG_CNFG_12_REG_DISKIP_MASK		BIT(CHG_CNFG_12_REG_DISKIP_SHIFT)
// REG=4.5V, UVLO=4.7V
