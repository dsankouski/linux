...
static int s6e3ha8_test_key_on_9f(struct mipi_dsi_device *dsi)
{
...
static int s6e3ha8_test_key_off_9f(struct mipi_dsi_device *dsi)
{
...
static int s6e3ha8_mdnie(struct s6e3ha8 *ctx)
{
	...
	s6e3ha8_test_key_on_f0(dsi);
	mipi_dsi_generic_write_seq(dsi, 0xdf, 0x01, 0x6a, 0x9a, 0x25, 0x1a, 0x16, 0x2a, 0x00, 0x37, 0x5a, 0x00, 0x4e, 0xc5, 0x00, 0x5d, 0x17, 0x00, 0x30, 0xc3, 0xff, 0x00, 0x00, 0xff, 0xff, 0x00, 0xff, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0xff, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0x00, 0xff, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0x00, 0xff, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00);
	mipi_dsi_generic_write_seq(dsi, );
	mipi_dsi_generic_write_seq(dsi, 0xdd, 0x01, 0x00, 0x07, 0xf0, 0x7f, 0x7f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xe2, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x01, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	s6e3ha8_test_key_off_f0(dsi);
...
static int s6e3ha8_enable(struct drm_panel *panel)
{
	...
	s6e3ha2_call_write_func(ret, s6e3ha8_test_key_on_9f(dsi));
	s6e3ha2_call_write_func(ret, mipi_dsi_dcs_set_display_on(dsi));
	s6e3ha2_call_write_func(ret, s6e3ha8_test_key_off_9f(dsi));
...
static int s6e3ha8_disable(struct drm_panel *panel)
{
	...
	s6e3ha2_call_write_func(ret, s6e3ha8_test_key_on_f0(dsi));
	s6e3ha2_call_write_func(ret, s6e3ha8_afc_off(dsi));
	s6e3ha2_call_write_func(ret, s6e3ha8_test_key_off_f0(dsi));

	msleep(160);
	panel->backlight->props.power = FB_BLANK_NORMAL;
