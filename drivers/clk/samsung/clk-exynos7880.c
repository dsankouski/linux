...
static const struct samsung_fixed_factor_clock top_fixed_factor_clks[] __initconst = {
	FFACTOR(CCORE_FF_MUX_MEDIA_PLL_DIV2, CCORE_FF_MUX_MEDIA_PLL_DIV2,	CCORE_MUX_MEDIA_PLL, 1,	2,	0);
    FFACTOR(CCORE_FF_MUX_BUS_PLL_DIV2, CCORE_FF_MUX_BUS_PLL_DIV2,	CCORE_MUX_BUS_PLL, 1,	2,	0);
    FFACTOR(MIF0_FF_MUX_ACLK_MIF_PLL_DIV2, MIF0_FF_MUX_ACLK_MIF_PLL_DIV2,	MIF0_MUX_ACLK_MIF_PLL, 1,	2,	0);
    FFACTOR(MIF0_FF_MUX_ACLK_MIF_PLL_DIV4, MIF0_FF_MUX_ACLK_MIF_PLL_DIV4,	MIF0_FF_MUX_ACLK_MIF_PLL_DIV2, 1,	2,	0);
    FFACTOR(MIF0_FF_ACLK_MIF_PHY, MIF0_FF_ACLK_MIF_PHY,	MIF0_MUX_ACLK_MIF_PLL, 1,	8,	0);
    FFACTOR(MIF1_FF_MUX_ACLK_MIF_PLL_DIV2, MIF1_FF_MUX_ACLK_MIF_PLL_DIV2,	MIF1_MUX_ACLK_MIF_PLL, 1,	2,	0);
    FFACTOR(MIF1_FF_MUX_ACLK_MIF_PLL_DIV4, MIF1_FF_MUX_ACLK_MIF_PLL_DIV4,	MIF1_FF_MUX_ACLK_MIF_PLL_DIV2, 1,	2,	0);
    FFACTOR(MIF1_FF_ACLK_MIF_PHY, MIF1_FF_ACLK_MIF_PHY,	MIF1_MUX_ACLK_MIF_PLL, 1,	8,	0);
}
