...
static struct pwrcal_pll_rate_table cpucl0_pll_rates[] = {
	PLL_RATE_MPS(1794000000,	207,	3,	0), #9
	PLL_RATE_MPS(1638000000,	189,	3,	0), #9
	PLL_RATE_MPS(1534000000,	177,	3,	0), #9
	PLL_RATE_MPS(1456000000,	168,	3,	0), #9
	PLL_RATE_MPS(1300000000,	150,	3,	0), #9
	PLL_RATE_MPS(1196000000,	138,	3,	0), #9
	PLL_RATE_MPS(1092000000,	126,	3,	0), #9
	PLL_RATE_MPS(1001000000,	154,	4,	0), #16
	PLL_RATE_MPS(897000000,	207,	3,	1), #18
	PLL_RATE_MPS(793000000,	244,	4,	1), #32
	PLL_RATE_MPS(689000000,	212,	4,	1), #32
	PLL_RATE_MPS(598000000,	184,	4,	1), #32
	PLL_RATE_MPS(494000000,	304,	4,	2), #64
	PLL_RATE_MPS(403000000,	248,	4,	2), #64
	PLL_RATE_MPS(299000000,	184,	4,	2), #64
	PLL_RATE_MPS(195000000,	240,	4,	3), #128
};
