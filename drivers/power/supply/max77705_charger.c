...
static int max77705_get_input_current(struct max77705_charger_data *charger, int *val)
{
	unsigned int reg_data;
	int get_current = 0;
	struct regmap *regmap = charger->regmap;
...
static int max77705_get_charge_current(struct max77705_charger_data *charger, int *val)
{
	unsigned int reg_data;
	struct regmap *regmap = charger->regmap;
...
static void max77705_charger_initialize(struct max77705_charger_data *chg)
{
	...
	regmap_update_bits(regmap, MAX77705_CHG_REG_CNFG_12,
				CHG_CNFG_12_VCHGIN_REG_MASK, MAX77705_VCHGIN_4_5);
	regmap_update_bits(regmap, MAX77705_CHG_REG_CNFG_12,
				CHG_CNFG_12_WCIN_REG_MASK, MAX77705_WCIN_4_5);
