...
static struct samsung_pin_bank_data exynos7880_pin_banks0[] = {
	EXYNOS7880_PIN_BANK_EINTN(6, 0x000, "etc0"),
	EXYNOS7880_PIN_BANK_EINTN(3, 0x020, "etc1"),
	EXYNOS7880_PIN_BANK_EINTW(8, 0x040, "gpa0", 0x00),
	EXYNOS7880_PIN_BANK_EINTW(8, 0x060, "gpa1", 0x04),
	EXYNOS7880_PIN_BANK_EINTW(8, 0x080, "gpa2", 0x08),
	EXYNOS7880_PIN_BANK_EINTW(5, 0x0a0, "gpa3", 0x0c),
	EXYNOS7880_PIN_BANK_EINTN(2, 0x0c0, "gpq0"),
};

/* pin banks of exynos7880 pin-controller 1 (CCORE) */
static struct samsung_pin_bank_data exynos7880_pin_banks1[] = {
	EXYNOS7880_PIN_BANK_EINTG(2, 0x000, "gpm0", 0x00),
};

/* pin banks of exynos7880 pin-controller 2 (DISPAUD) */
static struct samsung_pin_bank_data exynos7880_pin_banks2[] = {
	EXYNOS7880_PIN_BANK_EINTG(4, 0x000, "gpz0", 0x00),
	EXYNOS7880_PIN_BANK_EINTG(6, 0x020, "gpz1", 0x04),
	EXYNOS7880_PIN_BANK_EINTG(4, 0x040, "gpz2", 0x08),
};


/* pin banks of exynos7880 pin-controller 3 (ESE) */
static struct samsung_pin_bank_data exynos7880_pin_banks3[] = {
	EXYNOS7880_PIN_BANK_EINTG(5, 0x000, "gpc7", 0x00),
};

/* pin banks of exynos7880 pin-controller 4 (FSYS) */
static struct samsung_pin_bank_data exynos7880_pin_banks4[] = {
	EXYNOS7880_PIN_BANK_EINTG(3, 0x000, "gpr0", 0x00),
	EXYNOS7880_PIN_BANK_EINTG(8, 0x020, "gpr1", 0x04),
	EXYNOS7880_PIN_BANK_EINTG(2, 0x040, "gpr2", 0x08),
	EXYNOS7880_PIN_BANK_EINTG(4, 0x060, "gpr3", 0x0c),
	EXYNOS7880_PIN_BANK_EINTG(6, 0x080, "gpr4", 0x10),
};

/* pin banks of exynos7880 pin-controller 5 (NFC) */
static struct samsung_pin_bank_data exynos7880_pin_banks5[] = {
	EXYNOS7880_PIN_BANK_EINTG(4, 0x000, "gpc2", 0x00),
};

/* pin banks of exynos7880 pin-controller 6 (TOP) */
static struct samsung_pin_bank_data exynos7880_pin_banks6[] = {
	EXYNOS7880_PIN_BANK_EINTG(4, 0x000, "gpb0", 0x00),
	EXYNOS7880_PIN_BANK_EINTG(3, 0x020, "gpc0", 0x04),
	EXYNOS7880_PIN_BANK_EINTG(4, 0x040, "gpc1", 0x08),
	EXYNOS7880_PIN_BANK_EINTG(4, 0x060, "gpc4", 0x0c),
	EXYNOS7880_PIN_BANK_EINTG(2, 0x080, "gpc5", 0x10),
	EXYNOS7880_PIN_BANK_EINTG(4, 0x0a0, "gpc6", 0x14),
	EXYNOS7880_PIN_BANK_EINTG(2, 0x0c0, "gpc8", 0x18),
	EXYNOS7880_PIN_BANK_EINTG(2, 0x0e0, "gpc9", 0x1c),
	EXYNOS7880_PIN_BANK_EINTG(7, 0x100, "gpd1", 0x20),
	EXYNOS7880_PIN_BANK_EINTG(6, 0x120, "gpd2", 0x24),
	EXYNOS7880_PIN_BANK_EINTG(8, 0x140, "gpd3", 0x28),
	EXYNOS7880_PIN_BANK_EINTG(7, 0x160, "gpd4", 0x2c),
	EXYNOS7880_PIN_BANK_EINTG(5, 0x180, "gpd5", 0x30),
	EXYNOS7880_PIN_BANK_EINTG(3, 0x1a0, "gpe0", 0x34),
	EXYNOS7880_PIN_BANK_EINTG(4, 0x1c0, "gpf0", 0x38),
	EXYNOS7880_PIN_BANK_EINTG(2, 0x1e0, "gpf1", 0x3c),
	EXYNOS7880_PIN_BANK_EINTG(2, 0x200, "gpf2", 0x40),
	EXYNOS7880_PIN_BANK_EINTG(4, 0x220, "gpf3", 0x44),
	EXYNOS7880_PIN_BANK_EINTG(5, 0x240, "gpf4", 0x48),
};

/* pin banks of exynos7880 pin-controller 7 (TOUCH) */
static struct samsung_pin_bank_data exynos7880_pin_banks7[] = {
	EXYNOS7880_PIN_BANK_EINTG(3, 0x000, "gpc3", 0x00),
};
...
//		etc_offset += exynos7880_pin_ctrl[0].pin_banks[i].nr_pins;
//
//        return exynos7880_pin_ctrl[0].base + eint + etc_offset;
//}
//#endif

const struct samsung_pinctrl_of_match_data exynos7880_of_data __initconst = {
	.ctrl		= exynos7880_pin_ctrl,
	.num_ctrl	= ARRAY_SIZE(exynos7880_pin_ctrl),
};
